...
class KafkaConsumerConfigurationTest {
    ...
    void usesJacksonJsonWithoutJavaTypeHeaderCoupling() {
        contextRunner.run(context -> {
            ...
            assertThat(kafka.buildConsumerProperties())
                ...
                .containsEntry(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JacksonJsonDeserializer.class.getName())
                .containsEntry(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE,
                    "com.majm.rag.ingestion.domain.IngestionMessage")
                .containsEntry(JacksonJsonDeserializer.USE_TYPE_INFO_HEADERS, "false")
                .containsEntry(JacksonJsonDeserializer.TRUSTED_PACKAGES, "com.majm.rag.ingestion.domain");

            assertThat(kafka.buildProducerProperties())
